...
// var helloMessage = sayHello("Jeff");
...
//     var totalBill = ((tipPercent / 100) * bill) + bill;
//     return totalBill;
// }
...
//
// var totalBill = calculateTip(tipPercent, bill);
//
// alert("Your total bill is: " + totalBill);
// ***!!!Alternative method alert(calculateTip(tipPercent, bill));
...
//     var total = originalPrice - ((discountPercent / 100) * originalPrice);
//     return total;
// }
