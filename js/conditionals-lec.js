...
if (userAge < 15) {
    ...
    if (userAge === 15) {
     ...
     alert("You can get your license");
    } else if ((userAge >= 16) && !hasPermit) {
...
var weatherCondition = (prompt("What's the weather like?")).toLowerCase();
console.log("The current weather is " + weatherCondition;
switch
