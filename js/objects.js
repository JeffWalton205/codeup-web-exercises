(function() {
    ...
    shoppers.forEach(function(shopper) {
        //looking at one shopper at a time
        //checking each shopper's amount
        if (shopper.amount < 200) {
            console.log("No discount for you!");
        } else {
            //shopper amount earns discount here

            var newAmount = shopper.amount - (shopper.amount * .12);
            console.log("Your new price is " + newAmount);
        }
    });
    ...
    books.forEach(function(info) {
        ...
        console.log(info.title, info.author.firstName, info.author.lastName);
    });
